...
//   val albumLike = AlbumLike.fromJson(jsonString)
//   val playlistLike = PlaylistLike.fromJson(jsonString)
//   val likable = Likable.fromJson(jsonString)
...
data class AlbumLike (
    ...
    companion object {
        public fun fromJson(json: String) = klaxon.parse<AlbumLike>(json)
    }
}
...
data class Likable (
    ...
    companion object {
        public fun fromJson(json: String) = klaxon.parse<Likable>(json)
    }
}

...
//   val sale = Sale.fromJson(jsonString)
//   val albumSale = AlbumSale.fromJson(jsonString)
...
data class Sale (
    ...
    companion object {
        public fun fromJson(json: String) = klaxon.parse<Sale>(json)
    }
}
...
data class AlbumSale (
    ...
    companion object {
        public fun fromJson(json: String) = klaxon.parse<AlbumSale>(json)
    }
}
